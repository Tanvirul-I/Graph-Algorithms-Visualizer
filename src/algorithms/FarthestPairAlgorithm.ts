...
export class FarthestPairAlgorithm implements Algorithm {
        private graph!: Graph;
        ...
        initialize(graph: Graph): void {
                ...
                if (this.nodes.length < 2) {
                        this.stepInfo = "At least two nodes are required to compute the farthest pair.";
                ...
                this.stepInfo = "Initialized farthest pair search.";
        ...
        step(): boolean {
                ...
                if (this.i >= this.nodes.length - 1) {
                        this.presentBestPairResult("Farthest pair identified.");
                        return false;
                }
        ...
        private presentBestPairResult(message: string) {
                ...
                if (!this.bestPair) {
                        this.stepInfo = "Could not determine a farthest pair.";
